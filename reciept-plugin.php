...
if ( !class_exists( 'RefugeeConnect_receipts' ) ) {
    class RefugeeConnect_receipts
    {
        ...
        public function register_settings() {
          ...
          add_settings_section('settingssection1', 'Intuit App Settings', array( $this, 'settings_section_callback'), 'refugeeconnect_receipt_settings');
          ...
          add_settings_field( 'intuit_app_token', 'Intuit App Token', array( $this, 'settings_field'), 'refugeeconnect_receipt_settings', 'settingssection1', array('setting' => 'refugeeconnect_receipt_settings', 'field' => 'intuit_app_token', 'label' => '', 'class' => 'regular-text') );
          add_settings_field( 'intuit_app_oauth_key', 'Intuit Oauth Consumer Key', array( $this, 'settings_field'), 'refugeeconnect_receipt_settings', 'settingssection1', array('setting' => 'refugeeconnect_receipt_settings', 'field' => 'intuit_app_oauth_key', 'label' => '', 'class' => 'regular-text') );
          add_settings_field( 'intuit_app_oauth_secret', 'Intuit Oauth Consumer Secret', array( $this, 'settings_field'), 'refugeeconnect_receipt_settings', 'settingssection1', array('setting' => 'refugeeconnect_receipt_settings', 'field' => 'intuit_app_oauth_secret', 'label' => '', 'class' => 'regular-text') );
          add_settings_field( 'intuit_app_redirect_uri', 'Intuit App Redirect URI', array( $this, 'settings_field'), 'refugeeconnect_receipt_settings', 'settingssection1', array('setting' => 'refugeeconnect_receipt_settings', 'field' => 'intuit_app_redirect_uri', 'label' => '', 'class' => 'regular-text') );
        }
        ...
        function plugin_options() {
          ...
          <div class="wrap">
              ...
              <p>You'll need to go to the <a href="https://developer.intuit.com/v2/ui#/app/dashboard">Intuit Developers Console</a> to setup your project and setup the values below.</p>
